...
void test_ipv4_so_bindtodevice(void)
{
	int sock_c;
	int sock_s;
	struct sockaddr_in peer_addr_1, peer_addr_2;
	...
	peer_addr_1.sin_port = htons(DST_PORT);
	peer_addr_1.sin_addr = my_ipv4_addr1;
	peer_addr_2.sin_family = AF_INET;
	peer_addr_2.sin_port = htons(DST_PORT);
	peer_addr_2.sin_addr = my_ipv4_addr2;
...
void test_ipv6_so_bindtodevice(void)
{
	int sock_c;
	int sock_s;
	struct sockaddr_in6 peer_addr_1, peer_addr_2;
	...
	peer_addr_1.sin6_family = AF_INET6;
	peer_addr_1.sin6_port = htons(DST_PORT);
	peer_addr_1.sin6_addr = my_ipv6_addr1;
	peer_addr_2.sin6_family = AF_INET6;
	peer_addr_2.sin6_port = htons(DST_PORT);
	peer_addr_2.sin6_addr = my_ipv6_addr2;
